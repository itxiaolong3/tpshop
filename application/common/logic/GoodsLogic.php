...
class GoodsLogic extends Model
{
    ...
    public function collect_goods($user_id, $goods_id)
    {
        ...
        Db::name('goods')->where('goods_id', $goods_id)->setInc('collect_sum');//收藏总数
    ...
    public function add_visit_log($user_id,$goods){
        ...
        if($record){
            ...
            $visit = array('user_id'=>$user_id,'goods_id'=>$goods['goods_id'],'visittime'=>time(),'cat_id'=>$goods['cat_id'],'extend_cat_id'=>$goods['extend_cat_id']?$goods['extend_cat_id']:0);

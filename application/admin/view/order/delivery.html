        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td class="text-right">发货单号:</td>

                        <td class="text-center">
                            <input disabled onblur="$('#invoice_no').val($(this).val())" name="num" value="{$order.invoice_no}">
                            <a onclick="$(this).prev().attr('disabled',false)" data-toggle="tooltip" title="" data-original-title="修改订单号" class="btn btn-primary btn-xs">
                        ...
                        <div class="row">
                            <td colspan="4">
                                <div class="form-group text-center">
                                    <button onclick="ajax_submit_form('delivery-form','{:U('Admin/order/delivery',array('id'=>$order['order_id']))}');"  class="btn btn-primary" type="submit" id="disabled">生成发货单</button>

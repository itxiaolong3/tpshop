...
*/ 
    ...
    'erasable_type' =>['.gif','.jpg','.jpeg','.bmp','.png','.mp4','.3gp','.flv','.avi','.wmv','.mp3'],
    'COUPON_USER_TYPE'=>['全店通用','指定商品可用','指定分类商品可用'],
    'INVOUCE_TYPE'=>['普通发票','电子发票','增值税发票'],
    'image_upload_limit_size'=>1024 * 1024 * 5,//上传图片大小限制
    //小程序
    "APPID"=>"wx17a9c1dd0f96e1f2",
    "SECRET"=>"ccea00950a2d6634857a3d38b62baee2",
    //公众号
    "APPID_MP"=>"wx50c969f23c63e080",
    "SECRET_MP"=>"df0f1858e6eeb400f7e328db850ee197",

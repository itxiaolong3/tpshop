<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"./application/admin/view/promotion\search_goods.html";i:1540260088;s:51:"E:\tpshop\application\admin\view\public\layout.html";i:1540260088;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="padding: 0px 1% 0 1%;">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" id="search-form2" action="<?php echo U('Promotion/search_goods',['tpl'=>'search_goods']); ?>" method="get">
            ...
            <div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
                <table>
                    ...
                    <?php if(is_array($goodsList) || $goodsList instanceof \think\Collection || $goodsList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                        <tr <?php if($list['prom_id'] > 0): ?>hidden<?php endif; ?>>
                            <td class="" align="left">
                                <div style="text-align: left; width: 50px;">
                                    <input class="checkItem" type="checkbox" name="goods_id[]" value="<?php echo $list['goods_id']; ?>" data-img="<?php echo goods_thum_images($list['goods_id'],160,160); ?>"
                                           data-name="<?php echo $list['goods_name']; ?>" data-count="<?php echo $list['store_count']; ?>" data-price="<?php echo $list['shop_price']; ?>" data-cost-price="<?php echo $list['cost_price']; ?>"/>
                                </div>
                            </td>
                            <td class="" align="left">
                                <div style="text-align: center; width: 80px;"><?php echo $list['goods_id']; ?></div>
                            </td>
                            <td class="" align="left">
                                ...
                                <td class="tl" colspan="5">
                                    <div style="height: auto;white-space:normal;">
                                        <?php if(is_array($list[specGoodsPrice]) || $list[specGoodsPrice] instanceof \think\Collection || $list[specGoodsPrice] instanceof \think\Paginator): $i = 0; $__LIST__ = $list[specGoodsPrice];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$spec): $mod = ($i % 2 );++$i;?>
                                            <a class="<?php if($spec[prom_id] == 0 && $spec[store_count] > 0): ?>ncap-btn specBtn<?php else: ?>ncap-btn-dis<?php endif; ?>"
                                               data-item-id="<?php echo $spec['item_id']; ?>" data-cost-price="<?php echo $spec['cost_price']; ?>"

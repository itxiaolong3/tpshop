<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"./application/admin/view/index\welcome.html";i:1556240177;}*/ ?>
<html>
<head>
...
<!--<div id="footer" style="position: static; bottom: 0px; font-size:14px;">-->
    <!--<p><b>版权所有 © 2012-2027 <?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:'时代万网'); ?>，并保留所有权利。</b></p>-->
<!--</div>-->

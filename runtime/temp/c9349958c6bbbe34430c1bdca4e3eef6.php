<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view/article\questionlist.html";i:1556615005;s:51:"E:\tpshop\application\admin\view\public\layout.html";i:1540260088;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form action="<?php echo U('Article/questionlist'); ?>" class="navbar-form form-inline" method="get">
                <div class="sDiv">
                    <div class="sDiv2">
                        <input size="30" name="name" class="qsbox" placeholder="题目名称" type="text" value="<?php echo \think\Request::instance()->param('name'); ?>">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 150px;" class="">题目名称</div>
                        </th>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                <div class="fbutton">
                    <a class="type_info">
                        <div class="add" title="新增题目">
                            <span><i class="fa fa-plus"></i>新增题目</span>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="bDiv" style="height: auto;">
            <div id="flexigrid">
                <table>
                    <tbody>
                    <?php if(is_array($questions_list) || $questions_list instanceof \think\Collection || $questions_list instanceof \think\Paginator): $i = 0; $__LIST__ = $questions_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods_type): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td align="left" class="">
...
<script>
    ...
    function delete_type(type_id) {
        $.ajax({
            type: "POST",
            url: '/index.php?m=Admin&c=Article&a=deleteType',
            data: {id: type_id},
            dataType: "json",
            success: function (data) {
                if(data.status == 1){
    ...
    function add_edit_type(type_id) {
        var url = '/index.php?m=Admin&c=Article&a=question';
        if(type_id){
            url += '&id='+type_id;
        }
        layer.open({
